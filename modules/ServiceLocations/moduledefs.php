 ...
 **/             
//classic settings
$moduleList[] = 'ServiceLocations'; //comment in case module shall not be display in module administration > display modules and subpanels
$beanList['ServiceLocations'] = 'ServiceLocation';//'SpiceCRM\modules\ServiceLocations\ServiceLocation';
$beanFiles['ServiceLocation'] = 'modules/ServiceLocations/ServiceLocation.php';

//possible additional settings
//$modInvisList[] = 'ServiceLocations';
//$report_include_modules['ServiceLocations'] = 'ServiceLocation';
//$modules_exempt_from_availability_check['ServiceLocations']] = 'ServiceLocations'];
//$adminOnlyList['ServiceLocations'] = array('all' => 1);
