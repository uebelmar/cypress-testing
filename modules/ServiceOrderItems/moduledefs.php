 ...
 **/
//classic settings
$moduleList[] = 'ServiceOrderItems'; //comment in case module shall not be display in module administration > display modules and subpanels
$beanList['ServiceOrderItems'] = 'ServiceOrderItem';
$beanFiles['ServiceOrderItem'] = 'modules/ServiceOrderItems/ServiceOrderItem.php';
