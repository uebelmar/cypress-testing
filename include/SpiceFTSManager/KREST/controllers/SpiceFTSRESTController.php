...
class SpiceFTSRESTController
{

    /** @var SpiceFTSHandler|null */
    public $ftsHandler = null;
     ...
     * @return mixed
     */
    public function getStats($req, $res, $args)
    {
     ...
     * @return mixed
     */
    public function unblock($req, $res, $args)
    {
     ...
     * @return mixed
     */
    public function getFTSModuleFields($req, $res, $args)
    {
