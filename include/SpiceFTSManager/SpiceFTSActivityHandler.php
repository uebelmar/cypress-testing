...
class SpiceFTSActivityHandler
{
     ...
     */
    function loadActivities($activitiesmodule, $parentid, $start = 0, $limit = 10, $searchterm = '', $ownerfiler = '', $objects = [])
    {
...
//                $elastichandler->setHitsTotalValue($results, $newtotal);
     ...
     * @return array and array with the element totalcount, aggregates and items
     */
    function loadCalendarEvents($startdate, $enddate, $userId, $searchterm = '', $usersIds = [], $objects = [])
    {
