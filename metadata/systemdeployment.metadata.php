...
$dictionary['systemdeploymentrpdbentrys'] = array(
    'table' => 'systemdeploymentrpdbentrys',
    'comment' => 'holds potential additonal db records for the config server. In other scenarios records will be linked via CRs',
    'audited' => true,
    'fields' => array(
        'id' => array(
            'name' => 'id',
        ...
        'systemdeploymentrp_id' => array(
            'name' => 'systemdeploymentrp_id',
            'type' => 'id',
            'required' => true,
            'isnull' => false
        ),
    ...
    'indices' => array(
        array('name' => 'systemdeploymentrpdbentrys_id', 'type' => 'primary', 'fields' => array('id', 'deleted')),
        array('name' => 'systemdeploymentrpdbentrys_systemdeploymentrp_id', 'type' => 'index', 'fields' => array('systemdeploymentrp_id', 'deleted'))
    )
);
