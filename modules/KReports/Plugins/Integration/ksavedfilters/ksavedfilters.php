...
class ksavedfilter extends kreportintegrationplugin {

   public function __construct() {
      $this->pluginName = 'Saved Filters';
   }

//   public function getMenuItem() {
//      
//      return array(
//          'jsFile' => 'modules/KReports/Plugins/Integration/ksnapshots/ksnapshot' . (\SpiceCRM\includes\SugarObjects\SpiceConfig::getInstance()->config['KReports']['debug'] ? '_debug' : '') . '.js',
//          'menuItem' => array(
