<?php
namespace SpiceCRM\modules\ServiceTickets\KREST\controllers;
...
class ServiceTicketsKRESTController
{
    public function openInMyQueues($req, $res, $args) {
    ...
    public function myOpenItems($req, $res, $args) {
        $current_user = AuthenticationController::getInstance()->getCurrentUser();
    ...
    public function prolong($req, $res, $args) {
        $current_user = AuthenticationController::getInstance()->getCurrentUser();
