...
namespace SpiceCRM\modules\AccountVATIDs\KREST\controllers;
use Psr\Http\Message\RequestInterface;
use SpiceCRM\includes\SpiceSlim\SpiceResponse;


class AccountVATIDsKRESTController
{

    /**
     * gets the soap body of an curled url
    @param $req RequestInterface
     * @param $res SpiceResponse
     * @param $args
     * @return mixed
     */
    public function GetSoapBody($req,$res,$args){
