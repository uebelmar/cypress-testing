...
class SugarWebServiceImplv3_1 extends SugarWebServiceImplv3 {
    ...
    */
    function get_entry($session, $module_name, $id, $select_fields = array(), $link_name_to_fields_array  = array(),$track_view = FALSE)
    {
        LoggerManager::getLogger()->info('Begin: SugarWebServiceImpl->get_entry');
        return $this->get_entries($session, $module_name, array($id), $select_fields, $link_name_to_fields_array, $track_view);
