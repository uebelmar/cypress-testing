 ...
 * ****************************************************************************** */
namespace SpiceCRM\modules\WorkflowTaskDefinitions;

use SpiceCRM\data\SugarBean;

class WorkflowTaskDefinition extends SugarBean
{

    var $module_dir = 'WorkflowTaskDefinitions';
    var $object_name = 'WorkflowTaskDefinition';
    var $table_name = 'workflowtaskdefinitions';
